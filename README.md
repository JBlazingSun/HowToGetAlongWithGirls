# HowToGetAlongWithGirls · Dating Coach Skill 恋爱教练
...
An **AI dating coach** skill pack — built for Claude and other AI assistants, giving them a structured ability to analyze dating/relationship situations and offer grounded advice. Chinese is the primary working language; every skill file now ships with a full English mirror (`*.en.md`).
...
一个 **AI 恋爱教练** 技能包——专为 Claude 等 AI 助手设计，提供结构化的两性社交分析与建议能力。以中文为主，现在每个技能文件都附带完整英文镜像（`*.en.md`）。
